...
public class BrowserAgentDriver extends WebDriverPage {
    ...
    @Value("${browserAgentDriver.contextPath}")
    private String contextPath;

    @Value("${browserAgentDriver.serverUrl}")
    ...
    /**
     * Returns element by CSS selector. If it doen't exists it will wait for it to appear for up to 2 seconds.
     * 
    ...
    /**
     * Returns elements by CSS selector. If no elements exists it will for wait until at least 1 element appears or 2
     * seconds elapse.
     */
